 ...
 */
export function containerVerifierInvocation(options, request, limits) {
...
export class ContainerVerifierRunner {
    #options;
    constructor(options) {
        this.#options = { ...options };
    }
    async run(request, limits) {
        ...
        return new Promise((accept, reject) => {
            ...
            child.once('close', (code) => {
                finish(() => {
                    if (code !== 0) {
                        reject(new TypeError(`restricted verifier exited with ${String(code)}: `
