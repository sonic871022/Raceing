...
import type { CommitmentEnvelope, RevealEnvelope } from './commitment.js';
...
export declare function advanceTick<TLevel, TState, TView extends SessionView>(reducer: Reducer<TLevel, TState, TView>, state: TState, inputs: readonly SubmittedAction[]): TState;
/**
 ...
 */
export declare function replayMetricsFor<TLevel, TState, TView extends SessionView>(reducer: Reducer<TLevel, TState, TView>, state: TState, view?: TView): ReplayMetrics;
