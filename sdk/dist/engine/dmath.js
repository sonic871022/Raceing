...
const INV_PIO2_FIXED = 0xa2f9836e4e441529fc2757d1f534ddc0db6295993c439041fe5163abdebbc561n;
const PIO2_FIXED = 0x1921fb54442d18469898cc51701b839a252049c1114cf98e804177d4c76273644n;
...
function reduceTrig(x) {
    ...
    if (Math.abs(x) <= PI_OVER_4)
        return { quadrant: 0, reduced: x };
...
const JS_BACKEND = Object.freeze({
    id: 'js',
    sin: jsSin,
    cos: jsCos,
    atan2: jsAtan2,
...
export function createDmath(options = {}) {
    ...
    const checkedResult = (value, operation) => {
        if (!Number.isFinite(value)) {
