...
function assertPayloadUnicode(value, path = 'payload') {
...
function decodeLowerHex(value, label, minimum, maximum) {
...
export function canonicalCommitPayloadV1(payload) {
...
export function commitmentPreimageV1(binding, salt, payload) {
...
export function createCommitmentHash(binding, salt, payload) {
    return bytesToHex(sha256(commitmentPreimageV1(binding, salt, payload)));
}
export function assertCommitmentEnvelope(value) {
...
export function verifyCommitmentReveal(binding, commitment, reveal) {
